...
<html lang="en">
    <head>
        ...
        <title>Local Farmers Marketing Platform | Checkout</title>
        <!-- Favicon-->
...
?>
                ...
                <tr>
                    <td class="col-md-2"><img src="productimages/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="100" height="100"></td>
                    <td>
